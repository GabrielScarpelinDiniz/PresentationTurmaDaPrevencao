...
Para celebrarmos, vamos fazer uma dinâmica muito divertida com todos os alunos acerca do tema...... QUEIMADURAS!`,
  ...
  preload() {
    ...
    this.load.audio(
      "efeitoSonoroOnibus",
      "assets/sounds/efeitoSonoroOnibus.mp3"
    ...
    this.load.spritesheet(
      "jogador",
      "assets/spritesheets/playerPrincipal.png",
      {
        frameWidth: 32,
        frameHeight: 32,
      }
    ...
    this.load.image(
      "grade-lateral-left",
      "assets/tilemaps/grade-lateral-left.png"
    );
    this.load.image(
      "grade-lateral-right",
      "assets/tilemaps/grade-lateral-right.png"
    );
    this.load.image(
      "grade-lateral-right-01",
      "assets/tilemaps/grade-lateral-right-01.png"
    );
    this.load.image(
      "grade-lateral-left-01",
      "assets/tilemaps/grade-lateral-left-01.png"
    );
  ...
  create() {
    ...
    this.worldBounds = this.physics.add
      .staticGroup()
      .add(this.add.rectangle(0, 560, 3, 1120, 0x000000, 0))
      .add(this.add.rectangle(1120, 560, 3, 1120, 0x000000, 0))
      .add(this.add.rectangle(560, 0, 1120, 3, 0x000000, 0))
      .add(this.add.rectangle(560, 885, 1120, 3, 0x000000, 0));

    // Cria e posiciona o player
    this.jogador = this.physics.add
      .sprite(550, 800, "jogador")
      .setOffset(9, 12)
      .setCircle(7)
      .setScale(1.5)
      .refreshBody();
    ...
    this.npc01 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc01")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc02 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc02")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc03 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc03")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc04 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc04")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc05 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc05")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc06 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc06")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc07 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc07")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc08 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc08")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.npc09 = new NPCsAlunos(
      this.physics.add
        .sprite(575, 980, "npc09")
        .setSize(16, 18, 9, 10)
        .setVisible(false)
        .setScale(1.5)
        .refreshBody(),
    ...
    this.tina = this.physics.add
      .sprite(560, 400, "tina")
      .setOffset(8, 12)
      .setCircle(8)
      .setScale(2)
      .refreshBody()
      .setImmovable(); // Adiciona o sprite da Tina
    ...
    this.onibus = this.physics.add
      .image(80, 1000, "onibus")
      .setBodySize(150, 70)
      .setOffset(32, 70)
      .refreshBody();
    ...
    this.physics.add.collider(this.jogador, this.cerca, () =>
      console.log("Colidiu")
    );

    this.tinaCollider = this.physics.add.overlap(
      this.tina,
      this.jogador,
      () => {
        // Cria o overlap entre o jogador principal e a Tina
    ...
    const dialogoCompleto = () => {
      ...
      this.dialogText.on("pointerdown", () => {
        this.dialogText.skip();
      }); // Adiciona a função de pular o texto ao clicar no texto
      this.dialogText.proximoTexto(this.dialogo[this.atualDialogoIndice], () =>
        this.dialogBox.on("pointerdown", dialogoCompleto)
      ); // Adiciona o próximo texto ao diálogo
    };
    ...
    this.cameras.main.on("camerapancomplete", () => {
      ...
      if (this.maquinaEstado.currentState() === "cameraPanParaDialogo") {
        ...
        this.dialogText = new TypeWritter(
          this,
          420,
          353,
          "iosevka",
          this.dialogo[this.atualDialogoIndice],
          16,
          20,
          () => {
        ...
        this.maquinaEstado.currentState() === "entradaDosPersonagens"
      ) {
          ...
          callback: () => {
            ...
            if (this.npcControll === 10) {
              if (this[`npc0${this.npcControll - 1}`].aluno.y <= 700) {
                ...
                this.npc01.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc02.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc03.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc04.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc05.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc06.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc07.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc08.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
                ...
                this.npc09.setCollisionBetweenItens(
                  this.worldBounds,
                  this.cerca,
                  this.arvores,
                  this.faculdade,
  ...
  update() {
    ...
    if (
      this.onibus.x >= 575 &&
      this.maquinaEstado.currentState() === "cameraPanOnibus"
    ) {
    ...
    if (this.joystick.visible) {
      ...
      const velocityDoctorX =
        this.defaultVelocity *
        Math.cos(this.radiansAngleJoystick) *
        this.joystickForce;
      const velocityDoctorY = -(
        this.defaultVelocity *
        Math.sin(this.radiansAngleJoystick) *
        this.joystickForce
      );
      if (velocityDoctorX > 0)
        this.jogador.anims.play("playerWalkingRight", true);
      else if (velocityDoctorX < 0)
        this.jogador.anims.play("playerWalkingLeft", true);
      else if (velocityDoctorY == 0)
    ...
    if (
      Phaser.Math.Between(0, 1000) > 980 &&
      !this.newCar &&
      this.maquinaEstado.currentState() === "prontoParaJogar" &&
      !this.onibus
    ) {
  ...
  sortearCarro() {
    ...
    return this.physics.add
      .image(
        left === 1 ? 1120 : -0,
        left === 1 ? 925 : 1000,
        carros[carroSorteado]
      )
      .setBodySize(150, 70)
      .setOffset(32, 70)
      .setVelocityX(left === 1 ? -velocidade : velocidade)
      .setFlip(left === 0 ? false : true, false)
      .refreshBody();
  }
}
