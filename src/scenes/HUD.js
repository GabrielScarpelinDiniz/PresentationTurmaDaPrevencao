class CenaHUD extends Phaser.Scene {
  ...
  create() {
    ...
    this.fundoTimer = this.add
      .rectangle(635, 30, 210, 50, 0xadd8e6)
      .setVisible(false)
      .setAlpha(0.8);
    ...
    this.fundoTarefa = this.add
      .rectangle(5, 5, 450, 50, 0xadd8e6)
      .setVisible(false)
      .setAlpha(0.9)
      .setOrigin(0, 0);
    this.textoTarefa = this.add
      .text(10, 15, "Procure a dr.ª Tina", {
        fontSize: "36px",
        fill: "#000000",
      })
      .setVisible(false);
    ...
    this.fundoPontos = this.add
      .rectangle(1140, 30, 260, 50, 0xadd8e6)
      .setVisible(false)
      .setAlpha(0.9);
    this.textoPontos = this.add
      .text(1020, 15, "Pontos: 0", { fontSize: "36px", fill: "#000000" })
      .setVisible(false);
    ...
    const cenaFinal = this.scene.get("GameOver");
