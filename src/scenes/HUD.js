class UIScene extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.fundo = this.add.rectangle(630, 30, 150, 50, 0x75faff).setVisible(false);
        this.textoTempo = this.add.text(590,10,  this.tempoInicial + 's', { fontSize: '40px', fill: '#000000'}).setVisible(false); // Adiciona o texto do tempo na tela do jogo
            ...
            this.time.addEvent({ 
                ...
                callback: () => {
                    ...
                    if (this.tempoInicial < 100) {
                        //this.textoTempo.setPosition(570,400);
                    };
