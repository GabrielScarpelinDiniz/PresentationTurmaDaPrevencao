class GameOver extends Phaser.Scene {
  ...
  create() {
    ...
    this.botaoMenu = this.add.sprite(550, 575, "botaoMenu").setInteractive().setScale(0.3).setVisible(true).setScrollFactor(0); // Cria o botão de voltar para o menu
    this.botaoVoltar = this.add.sprite(750, 585, "botaoInicio").setInteractive().setScale(0.3).setVisible(true).setScrollFactor(0); // Cria o botão de voltar para o início do jogo
    this.textoPontuacao = this.add.text(400, 400, "Pontuação:", { // Cria o texto para informar a pontuação final
        fontSize: "36px",
        fill: "#000000",
      })
      .setVisible(true);
